...
###STEP 2: Start on doing the models to find best result
	...
	finalkidcov<- data.frame(kidall[,c(56206:56223)])	
	rownames(finalkidcov)=kidall[,1]
	finalkidL1HS<- data.frame(kidall[,c(56205)])
	rownames(finalkidL1HS)= kidall[,1]
	colnames(finalkidL1HS)= c("L1HS")
	finalkidgenes<- data.frame(kidall[,c(3:56204)])
	rownames(finalkidgenes)=kidall[,1]
	library(nlme)
	library(MuMIn)
	library(lmSupport)
	library(qvalue)
	...
	finalAICc=NULL
		...
		{
		valuepc0 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,1])
		valuepc1 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,2])
		valuepc2 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,3])
		valuein1 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,4])
		valuein2 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,5])
		valuein3 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,6])
		valuein4 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,7])
		valuein5 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,8])
		valuein6 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,9])
		valuein7 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,10])
		valuein8 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,11])
		valuein9 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,12])
		valuein10 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,13])
		valuein11 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,14])
		valuein12 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,15])
		valuein13 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,16])
		valuein14 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,17])
		valuein15 <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,18])
		valueall <-lm(finalkidL1HS[,1] ~ finalkidgenes[,c(i)] + finalkidcov[,1] + finalkidcov[,2] + 
					...
					finalkidcov[,13] + finalkidcov[,14] + finalkidcov[,15] + finalkidcov[,16] + finalkidcov[,17] + finalkidcov[,18])
	...
	setwd("/home/quints1/Correlations/kidney")
	write.table(finalAICc, "AllAICcresultskidney.txt", sep="\t", quote=FALSE)
	...
	for (i in colnames(finalkidgenes))
		...
		setwd("/home/quints1/Correlations/kidney")
		write.table(finalresults, "P and Q kidney.txt", sep="\t", quote=FALSE)
		...
		setwd("/home/quints1/Correlations/kidney")
		write.table(finalresults, "PRandQKidney.txt", sep="\t", quote=FALSE, row.names=FALSE,col.names=TRUE)
