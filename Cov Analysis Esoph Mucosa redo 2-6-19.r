...
library("stringr")
	...
	setwd("/home/quints1/Correlations/esophagusmucosa")
	write.table(finalAICc, "AllAICcresultsesophmucosa redo.txt", sep="\t", quote=FALSE)
	...
	for (i in colnames(finalesophgenes))
		...
		setwd("/home/quints1/Correlations/esophagusmucosa")
		write.table(finalresults, "P and Q esophmucosa redo.txt", sep="\t", quote=FALSE)
		...
		setwd("/home/quints1/Correlations/esophagusmucosa")
		write.table(finalresults, "PRandQEsophMucosa redo.txt", sep="\t", quote=FALSE, row.names=FALSE,col.names=TRUE)
