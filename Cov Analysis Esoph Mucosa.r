...
###STEP 2: Start on doing the models to find best result
	...
	setwd("/home/quints1/Correlations/esophagusmucosa")
	write.table(finalAICc, "AllAICcresultsesophmucosa.txt", sep="\t", quote=FALSE)
	...
	for (i in colnames(finalesophgenes))
		...
		setwd("/home/quints1/Correlations/esophagusmucosa")
		write.table(finalresults, "P and Q esophmucosa.txt", sep="\t", quote=FALSE)
		...
		setwd("/home/quints1/Correlations/esophagusmucosa")
		write.table(finalresults, "PRandQEsophMucosa.txt", sep="\t", quote=FALSE, row.names=FALSE,col.names=TRUE)
